...
s2.insertTableEntry(table_name='MyIngress.local_routing',
        ...
        action_name='MyIngress.send_to_cpu')
s1.insertTableEntry(table_name='MyIngress.local_routing',
        match_fields={'hdr.ipv4.dstAddr': '10.0.1.10'},
        action_name='MyIngress.ipv4_match',
        action_params={'port': 2, 'dstAddr':'10.0.1.10'})
s1.insertTableEntry(table_name='MyIngress.local_routing',
        match_fields={'hdr.ipv4.dstAddr': '10.0.5.10'},
        action_name='MyIngress.ipv4_match',
        action_params={'port': 4, 'dstAddr':'10.0.5.10'})
s2.insertTableEntry(table_name='MyIngress.local_routing',
        match_fields={'hdr.ipv4.dstAddr': '10.0.2.10'},
        action_name='MyIngress.ipv4_match',
        action_params={'port': 2, 'dstAddr':'10.0.2.10'})
